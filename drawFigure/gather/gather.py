...
def parse_args(default_input_dir_name: str = "analyse"):
    base_dir = Path(__file__).resolve().parents[1]
    default_input = base_dir / default_input_dir_name
...
def main(input_dir_name: str = "analyse"):
    args = parse_args(default_input_dir_name=input_dir_name)
